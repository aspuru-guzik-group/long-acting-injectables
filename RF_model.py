...
# set random forest regressor to RF
...
rnd_search_cv = RandomizedSearchCV(RF, param_distribs, n_iter=100,verbose=3, cv=logo, scoring='neg_mean_absolute_error')
...
# train RF based on best paramaters identified during rnd_search and return model structure
regressor=rnd_search_cv.best_estimator_
regressor.fit(X=X,y=Y)

# saved trained RF model to pickle file
Pkl_Filename = "RF.pkl"  
