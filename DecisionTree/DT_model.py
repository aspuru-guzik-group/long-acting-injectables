...
# set decision tree regressor to DT
...
rnd_search_cv = RandomizedSearchCV(DT, param_distribs, n_iter=250,verbose = 3, cv=logo, scoring='neg_mean_absolute_error')
...
# train DT based on best paramaters identified during rnd_search and return model structure
regressor=rnd_search_cv.best_estimator_
regressor.fit(X=X,y=Y)

# saved trained DT model to pickle file
Pkl_Filename = "DT.pkl"  
