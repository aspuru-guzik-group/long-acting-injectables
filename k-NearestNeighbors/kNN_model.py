...
rnd_search_cv = RandomizedSearchCV(kNN, param_distribs, n_iter=250,verbose = 3, cv=logo, scoring='neg_mean_absolute_error')
...
# train kNN based on best paramaters identified during rnd_search and return model structure
regressor=rnd_search_cv.best_estimator_
regressor.fit(X=X,y=Y)

# saved trained kNN model to pickle file
