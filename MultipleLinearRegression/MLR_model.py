...
# set multiple linear regressor to MLR
...
# run rnd_search applying logo for each of the 2 interation and scoring based on mean absolute error
rnd_search_cv = RandomizedSearchCV(MLR, param_distribs, n_iter=2,verbose = 3, cv=logo, scoring='neg_mean_absolute_error')
...
# train MLR based on best paramaters identified during rnd_search and return model structure
regressor=rnd_search_cv.best_estimator_
regressor.fit(X=X,y=Y)

# save trained MLR model to pickle file
Pkl_Filename = "MLR.pkl"  
